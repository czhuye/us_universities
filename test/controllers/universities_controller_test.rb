...
class UniversitiesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create university" do
    assert_difference("University.count") do
      post universities_url, params: { university: { city: @university.city, name: @university.name, photo: @university.photo, program: @university.program, rank: @university.rank, state: @university.state, zip: @university.zip } }
    end
  ...
  test "should update university" do
    patch university_url(@university), params: { university: { city: @university.city, name: @university.name, photo: @university.photo, program: @university.program, rank: @university.rank, state: @university.state, zip: @university.zip } }
